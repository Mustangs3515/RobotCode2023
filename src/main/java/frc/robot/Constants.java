...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double drivePosition = 5;
    public static final double ScorePosition = 50;
    public static final double groundPosition = 15;
  }
  ...
  public static final class GripperConstants {
    ...
    public static final double kForward = 100;
    public static final double kReverse = -100;
  ...
  public static final class PivotConstants {
    ...
    public static final double ScorePosition = 100;
    public static final double GroundPosition = 225;
  }
